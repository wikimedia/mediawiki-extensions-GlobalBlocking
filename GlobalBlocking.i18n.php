...
To view all active global blocks, you may view the [[Special:GlobalBlockList|global block list]].',
	...
	'globalblocking-loglink' => 'Check the global block status of the IP address [[{{#Special:GlobalBlockList}}/$1|$1]].',
...
Für eine Liste aller aktiven globalen Sperren siehe die [[Special:GlobalBlockList|globale Sperrliste]].',
	...
	'globalblocking-loglink' => 'Status der globalen Sperre der IP-Adresse [[{{#Special:GlobalBlockList}}/$1|$1]] prüfen.',
...
Tüm aktif küresel engellemeri görmek için, [[Special:GlobalBlockList|küresel engelleme listesine]] bakabilirsiniz.',
	...
	'globalblocking-loglink' => 'Halê kılitkerdışiê IP-adresa globali [[{{#Special:GlobalBlockList}}/$1|$1]] qontrol ke.',
...
seega ei saa globaalsete blokeeringute kohalikku olekut muuta.',
	...
	'globalblocking-whitelist-reason' => 'Muutmise põhjus:',
...
$messages['id'] = array(
	...
	'globalblocking-block-legend' => 'Memblokir alamat IP secara global',
...
Harap masukkan alamat IP yang sah.',
	...
	'globalblocking-list-noresults' => 'Alamat IP yang diminta tidak sedang di blokir.',
...
Fir all aktiv global Spären ze gesinn, gitt w.e.g op d'[[Special:GlobalBlockList|Lëscht vun de globale Spären]].",
	...
	'globalblocking-loglink' => 'De Status vun der globaler Spär vun der IP-Adress [[{{#Special:GlobalBlockList}}/$1|$1]] nokucken.',
...
അല്ലങ്കിൽ ഈ ഫോം പുനർസമർപ്പിച്ച് ക്രമീകരണങ്ങളിൽ മാറ്റം വരുത്താവുന്നതാണ്.',
...
താങ്കള്‍ക്കു ഇവിടെ ഒരു ഉപയോക്തൃനാമം കൊടുക്കുവാന്‍ പറ്റില്ല എന്നതു പ്രത്യേകം ശ്രദ്ധിക്കുക.',
	...
	'globalblocking-unblock-errors' => 'ഈ ഐപി വിലാസത്തിന്മേലുള്ള ആഗോള തടയൽ ഒഴിവാക്കാന്‍ താങ്കള്‍ക്ക് പറ്റില്ല, അതിന്റെ {{PLURAL:$1|കാരണം|കാരണങ്ങൾ}}: $1',
...
[[Special:GlobalBlockList|ആഗോള തടയലുകളുടെ പട്ടികയിലേയ്ക്ക് തിരിച്ചുപോവുക]]',
	...
	'globalblocking-loglink' => 'ഐ.പി. വിലാസം [[{{#Special:GlobalBlockList}}/$1|$1]] ഉൾപ്പെട്ട ആഗോള തടയലിന്റെ സ്ഥിതി പരിശോധിക്കുക.',
...
Alle globale blokkades staan in de [[Special:GlobalBlockList|lijst met globale blokkades]].",
	...
	'globalblocking-loglink' => 'De globale blokkadestatus van het IP-adres [[{{#Special:GlobalBlockList}}/$1|$1]] controleren.',
...
Wszystkie aktywne globalne blokady można zobaczyć w [[Special:GlobalBlockList|spisie globalnie zablokowanych adresów IP]].',
	...
	'globalblocking-loglink' => 'Sprawdź czy adres IP [[{{#Special:GlobalBlockList}}/$1|$1]] jest zablokowany globalnie.',
...
Чтобы просмотреть список всех глобальных блокировок, обратитесь к [[Special:GlobalBlockList|соответствующему списку]].',
	...
	'globalblocking-loglink' => 'Проверить состояние глобальной блокировки IP адреса [[{{#Special:GlobalBlockList}}/$1|$1]].',
