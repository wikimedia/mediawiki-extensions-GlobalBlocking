...
-- Source: extensions/GlobalBlocking/sql/abstractSchemaChanges/patch-global_block_whitelist-drop-gbw_address.json
...
INSERT INTO /*_*/global_block_whitelist (
    gbw_id, gbw_target_central_id, gbw_by,
    gbw_by_text, gbw_reason, gbw_expiry
  )
SELECT
  gbw_id,
  gbw_target_central_id,
